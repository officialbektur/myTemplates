...
function remSreenWidth() {
	let remSreenWidth = (window.innerWidth / parseFloat(window.getComputedStyle(document.documentElement, null).getPropertyValue('font-size')));
...
export function windowOnScroll() {
	if (document.querySelector('.up__button')) {
